...
describe("F-087..F-091 typed block runtime", () => {
  ...
  it("runs BLOCK, INSERT, BEDIT, ATTRIB and EXPLODE as individual atomic commands", () => {
    ...
    workflow.commit({ commandId: "BEDIT", insertHandle: "20", basePoint: { x: 0, y: 0 }, entities: [{ kind: "line", handle: "11", layerId: "0", start: { x: 0, y: 0 }, end: { x: 150, y: 0 } }] }, "bedit:1");
    ...
    workflow.commit({ commandId: "EXPLODE", insertHandle: "20" }, "explode:1");
