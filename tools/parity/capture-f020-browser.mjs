...
await run(process.execPath, [resolve(root, "node_modules/playwright/cli.js"), "test", "e2e/f020-mirror.spec.ts"], {
  PARITY_CAPTURE_DIR: captureDir,
});
await run(process.execPath, [resolve(root, "tools/parity/build-f020-browser-readback.mjs")]);
