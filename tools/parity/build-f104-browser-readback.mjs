...
if (
  ...
  !svgSummary.physicalA3 || svgSummary.viewportIds.join("|") !== "viewport-f104-50|viewport-f104-100" || svgSummary.rectClips !== 1 || svgSummary.polygonClips !== 1 || !svgSummary.scale50 || !svgSummary.scale100 || !svgSummary.title || !svgSummary.alpha60 || svgSummary.images !== 0 ||
  ...
  !/^\d+\./u.test(independentPdfReadback.readers?.pypdf ?? "") || !/^\d+\./u.test(independentPdfReadback.readers?.pdfplumber ?? "") || independentPdf?.pypdf?.strictParsed !== true || independentPdf?.pypdf?.pages !== 1 || independentPdf?.pypdf?.imageXObjects !== 0 || independentPdf?.pdfplumber?.images !== 0 || independentPdf?.pypdf?.operators?.W !== 2 || independentPdf?.pypdf?.operators?.cm !== 3 ||
