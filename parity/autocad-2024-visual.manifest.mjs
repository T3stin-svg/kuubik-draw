...
export const VISUAL_STATES = Object.freeze([
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-3/visual-shell-empty-workspace.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-3/visual-shell-zones.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-3/visual-shell-active-command.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-3/visual-shell-states.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-3/visual-shell-selected-properties.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-3/visual-shell-states.json",
  }),
  Object.freeze({
    id: "layer-manager",
    ...
    status: "KUUBIK_CAPTURED",
    autoCadEvidence: Object.freeze({ ref: "private://autocad-2024/selected-properties", sha256: "6a9037b0ec7bad08692f2ebdbd3da4b09aa125bde1efc2a3de66223b9c82ef0c" }),
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-3/visual-shell-layer-manager.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-3/visual-shell-states.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-3/visual-shell-layout-paper-space.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-3/visual-shell-states.json",
  }),
  Object.freeze({
    ...
    status: "KUUBIK_CAPTURED",
    autoCadEvidence: null,
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-3/visual-shell-command-history.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-3/visual-shell-states.json",
  }),
]);
