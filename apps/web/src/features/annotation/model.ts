...
export const ANNOTATION_PROMPT_PLANS: Readonly<Record<AnnotationCommandId, AnnotationPromptPlan>> = Object.freeze({
  DIMLINEAR: { commandId: "DIMLINEAR", fields: [
    ...
    { id: "axis", label: "Suund", valueKind: "select", required: true, choices: ["horizontal", "vertical", "rotated"] },
    { id: "rotationRad", label: "Pöördenurk (rad)", valueKind: "number", required: false },
    { id: "textPoint", label: "Mõõtteksti asukoht", valueKind: "point", required: false },
    { id: "overrideText", label: "Teksti ülekirjutus", valueKind: "string", required: false },
  ...
  MTEXT: { commandId: "MTEXT", fields: [
    { id: "mode", label: "Tegevus", valueKind: "select", required: false, choices: ["create", "edit"] },
    { id: "targetHandle", label: "Muudetav MTEXT", valueKind: "string", required: false },
    { id: "patch", label: "MTEXT muudatused", valueKind: "attributes", required: false },
    { id: "position", label: "Sisestuspunkt", valueKind: "point", required: false },
    { id: "text", label: "Tekst", valueKind: "string", required: false },
    { id: "height", label: "Kõrgus", valueKind: "number", required: false },
    { id: "width", label: "Tekstiala laius", valueKind: "number", required: false },
    { id: "rotationRad", label: "Pööre", valueKind: "number", required: false },
    { id: "styleId", label: "Tekstistiil", valueKind: "string", required: false },
    ...
    { id: "wrapMode", label: "Reamurdmine", valueKind: "select", required: false, choices: ["word", "character", "none"] },
    { id: "paragraphs", label: "Lõigud", valueKind: "attributes", required: false },
  ] },
  STYLE: { commandId: "STYLE", fields: [
    { id: "mode", label: "Tegevus", valueKind: "select", required: true, choices: ["create", "update", "apply"] },
    { id: "style", label: "Tekstistiil", valueKind: "attributes", required: false },
    { id: "styleId", label: "Rakendatav tekstistiil", valueKind: "string", required: false },
  ] },
  LEADER: { commandId: "LEADER", fields: [
    { id: "mode", label: "Tegevus", valueKind: "select", required: false, choices: ["create", "edit"] },
    { id: "targetHandle", label: "Muudetav viit", valueKind: "string", required: false },
    { id: "patch", label: "Viida muudatused", valueKind: "attributes", required: false },
    { id: "vertices", label: "Viitjoone punktid", valueKind: "points", required: false },
    { id: "text", label: "Tekst", valueKind: "string", required: false },
    { id: "contentPosition", label: "Sisu asukoht", valueKind: "point", required: false },
    { id: "textStyleId", label: "Tekstistiil", valueKind: "string", required: false },
    { id: "textHeight", label: "Teksti kõrgus", valueKind: "number", required: false },
    { id: "arrowType", label: "Noole tüüp", valueKind: "select", required: false, choices: ["closed-filled", "open", "dot", "none"] },
    { id: "arrowSize", label: "Noole suurus", valueKind: "number", required: false },
    { id: "landingEnabled", label: "Õlg", valueKind: "boolean", required: false },
    { id: "landingLength", label: "Õla pikkus", valueKind: "number", required: false },
    { id: "associative", label: "Assotsiatiivne", valueKind: "boolean", required: false },
  ] },
  MLEADER: { commandId: "MLEADER", fields: [
    { id: "mode", label: "Tegevus", valueKind: "select", required: false, choices: ["create", "edit"] },
    { id: "targetHandle", label: "Muudetav multiviide", valueKind: "string", required: false },
    { id: "patch", label: "Multiviite muudatused", valueKind: "attributes", required: false },
    { id: "vertices", label: "Multiviite punktid", valueKind: "points", required: false },
    { id: "text", label: "Tekst", valueKind: "string", required: false },
    { id: "textPosition", label: "Teksti asukoht", valueKind: "point", required: false },
    { id: "styleId", label: "Multiviite stiil", valueKind: "string", required: false },
    { id: "textHeight", label: "Teksti kõrgus", valueKind: "number", required: false },
    { id: "textStyleId", label: "Tekstistiil", valueKind: "string", required: false },
  ...
  HATCH: { commandId: "HATCH", fields: [
    { id: "mode", label: "Tegevus", valueKind: "select", required: false, choices: ["create", "edit"] },
    { id: "targetHandle", label: "Muudetav viirutus", valueKind: "string", required: false },
    { id: "patch", label: "Viirutuse muudatused", valueKind: "attributes", required: false },
    { id: "boundaryHandles", label: "Piirid", valueKind: "handles", required: false },
    { id: "pattern", label: "Muster", valueKind: "string", required: false },
    { id: "angleRad", label: "Nurk", valueKind: "number", required: false },
    { id: "scale", label: "Mõõtkava", valueKind: "number", required: false },
    { id: "associative", label: "Assotsiatiivne", valueKind: "boolean", required: false },
    { id: "islandDetection", label: "Saarte tuvastus", valueKind: "select", required: false, choices: ["normal", "outer", "ignore"] },
