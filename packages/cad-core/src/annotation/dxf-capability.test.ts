...
function fixture() {
  ...
  document.entities.push(
    ...
    withAnnotationExtension({ kind: "hatch", handle: "H1", layerId: "0", pattern: "ANSI31", associative: true, loops: [{ isHole: false, vertices: [{ x: 0, y: 0 }, { x: 20, y: 0 }, { x: 20, y: 20 }] }, { isHole: true, vertices: [{ x: 5, y: 5 }, { x: 10, y: 5 }, { x: 10, y: 10 }] }] }, { kind: "hatch", islandDetection: "normal", pattern: { type: "line", angleRad: 0, scale: 1, origin: { x: 0, y: 0 } }, boundaryHandles: ["P1", "P2"] }),
