...
export const SOURCE_GROUPS = Object.freeze({
  ...
  "f026-shared-tests": Object.freeze([
    "apps/web/src/workflows/modify-command.test.ts",
    ...
    "parity/F-026-scope.md",
    "parity/autocad/F-026-core.scr",
    "tools/autocad/f026-runner.test.mjs",
    "tools/autocad/f026-standard-matrix.ps1",
    "tools/autocad/process-ownership.mjs",
    "tools/autocad/run-f026.mjs",
    "tools/autocad/run-f026-core.mjs",
    ...
    "tools/parity/check-f026-cross-evidence.mjs",
  ]),
  "oracle-lab-f026": Object.freeze([
    "tools/oracles/freecad-f026-headless.py",
    "tools/oracles/network-isolation.mjs",
    "tools/oracles/pins.json",
    "tools/oracles/probe-tools.mjs",
    "tools/oracles/run-fixtures.mjs",
  ...
  "certification-global": Object.freeze([
    ...
    "parity/autocad-2024-visual.manifest.mjs",
    "parity/check-visual.mjs",
    "parity/rows.mjs",
...
export const UNCERTIFIED_SOURCE_ROWS = Object.freeze({
  "package.json": Object.freeze(["F-012", "F-028", "F-030"]),
  "package-lock.json": Object.freeze(["F-012", "F-030"]),
  "apps/web/package.json": Object.freeze(["F-012", "F-030"]),
  "apps/web/src/App.tsx": Object.freeze(["F-012", "F-028", "F-030"]),
  "apps/web/src/style.css": Object.freeze(["F-030"]),
  "apps/web/src/workflows/modify-command.ts": Object.freeze(["F-028", "F-030"]),
  "packages/cad-core/src/commands.ts": Object.freeze(["F-012", "F-028", "F-030"]),
  "packages/cad-core/src/index.ts": Object.freeze(["F-012", "F-028", "F-030"]),
  "packages/cad-core/src/spline.ts": Object.freeze(["F-012"]),
  ...
  "packages/cad-core/package.json": Object.freeze(["F-012", "F-030"]),
  "packages/cad-dxf/package.json": Object.freeze(["F-012", "F-030"]),
  "packages/cad-core/src/trim.ts": Object.freeze(["F-028"]),
  "packages/cad-dxf/src/import.ts": Object.freeze(["F-012", "F-030"]),
  "packages/cad-dxf/src/index.ts": Object.freeze(["F-012", "F-030"]),
  "packages/cad-renderer/src/renderer.ts": Object.freeze(["F-030"]),
  "packages/cad-renderer/package.json": Object.freeze(["F-012", "F-030"]),
  "packages/cad-print/package.json": Object.freeze(["F-012", "F-030"]),
  "packages/cad-core/test/spline.test.ts": Object.freeze(["F-012"]),
  "packages/cad-core/test/f012-mutation-proven.test.ts": Object.freeze(["F-012"]),
  "packages/cad-dxf/test/f012-spline-fit-roundtrip.test.ts": Object.freeze(["F-012"]),
  "parity/autocad/F-012.scr": Object.freeze(["F-012"]),
  "tools/autocad/f012-core-evidence.mjs": Object.freeze(["F-012"]),
  "tools/autocad/f012-core-runner.test.mjs": Object.freeze(["F-012"]),
  "tools/autocad/f012-runner.test.mjs": Object.freeze(["F-012"]),
  "tools/autocad/f012-standard-matrix.ps1": Object.freeze(["F-012"]),
  "tools/autocad/run-f012-core.mjs": Object.freeze(["F-012"]),
  "tools/autocad/run-f012.mjs": Object.freeze(["F-012"]),
  "e2e/f012-spline.spec.ts": Object.freeze(["F-012"]),
  "parity/F-012-scope.md": Object.freeze(["F-012"]),
  "tools/parity/run-f012-readback.mjs": Object.freeze(["F-012"]),
  "tools/oracles/freecad-f012-headless.py": Object.freeze(["F-012"]),
  "tools/oracles/run-f012-oracles.mjs": Object.freeze(["F-012"]),
  ...
  "e2e/helpers/model-space.ts": Object.freeze(["F-028", "F-030"]),
  ...
  "e2e/helpers/layout-tools.ts": Object.freeze(["F-030"]),
...
const groupsByRow = Object.freeze({
  ...
  "F-022": ["web-modify-workflow", "cad-modify", "cad-trim", "physical-shift-input", "model-space-e2e", "dxf"],
  "F-023": ["web-modify-workflow", "cad-modify", "cad-trim", "physical-shift-input", "model-space-e2e", "dxf"],
  "F-024": ["web-modify-workflow", "cad-container", "cad-modify", "cad-trim", "cad-fillet", "physical-shift-input", "model-space-e2e", "dxf", "dxf-import", "print", "f024-shared-tests", "oracle-lab-f024"],
  "F-025": ["web-modify-workflow", "cad-container", "cad-modify", "cad-chamfer", "physical-shift-input", "model-space-e2e", "dxf", "dxf-import", "f025-shared-tests", "oracle-lab-f025"],
  "F-026": ["web-modify-workflow", "cad-container", "cad-modify", "cad-break", "cad-trim", "model-space-e2e", "dxf", "dxf-import", "f026-shared-tests", "oracle-lab-f026"],
  "F-027": ["web-modify-workflow", "cad-container", "cad-modify", "cad-stretch", "cad-trim", "model-space-e2e", "dxf", "dxf-import", "f027-shared-tests", "oracle-lab-f027"],
  "F-029": ["web-modify-workflow", "cad-container", "cad-modify", "cad-trim", "model-space-e2e", "dxf", "dxf-import", "f029-shared-tests", "oracle-lab-f029"],
  ...
  "F-106": ["cad-layout", "cad-page-setup", "model-space-e2e", "print"],
