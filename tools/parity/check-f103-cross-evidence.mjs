...
const checks = {
  ...
  autoCadOwnedAndClean: autocad.engineVersion?.startsWith("24.3") && autocad.automationProcessOwned === true && autocad.automationProcessTerminated === true && autocad.noResidualAcadProcesses === true && autocad.userSettings?.restored === true,
