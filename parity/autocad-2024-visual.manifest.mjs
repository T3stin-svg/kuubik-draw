...
export const VISUAL_STATES = Object.freeze([
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-empty-workspace.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-zones.json",
    supplementalMeasuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-states.json",
    comparisonReadback: "evidence/artifacts/visual-shell-wave-12/autocad-light-model-readback.json",
    supplementalComparisonReadback: "evidence/artifacts/visual-shell-wave-12/autocad-ribbon-readback.json",
    chromeComparisonReadback: "evidence/artifacts/visual-shell-wave-12/autocad-top-chrome-readback.json",
    bottomComparisonReadback: "evidence/artifacts/visual-shell-wave-12/autocad-bottom-chrome-readback.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-active-command.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-states.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-selected-properties.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-states.json",
    comparisonReadback: "evidence/artifacts/visual-shell-wave-12/autocad-selected-properties-readback.json",
  }),
  Object.freeze({
    id: "layer-manager",
    ...
    status: "KUUBIK_CAPTURED",
    autoCadEvidence: Object.freeze({ ref: "private://autocad-2024/selected-properties", sha256: "6a9037b0ec7bad08692f2ebdbd3da4b09aa125bde1efc2a3de66223b9c82ef0c" }),
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-layer-manager.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-states.json",
    comparisonReadback: "evidence/artifacts/visual-shell-wave-12/autocad-selected-properties-readback.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-layout-paper-space.png",
    supplementalKuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-layout-tools-open.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-states.json",
  }),
  Object.freeze({
    ...
    kuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-command-history.png",
    supplementalKuubikEvidence: "evidence/artifacts/visual-shell-wave-12/visual-shell-context-menu.png",
    measuredReadback: "evidence/artifacts/visual-shell-wave-12/visual-shell-states.json",
