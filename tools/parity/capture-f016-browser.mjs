...
await run(process.execPath, [resolve(root, "node_modules/playwright/cli.js"), "test", "e2e/f016-move.spec.ts"], {
  PARITY_CAPTURE_DIR: captureDir,
});
await run(process.execPath, [resolve(root, "tools/parity/build-f016-browser-readback.mjs")]);
