...
- the new application has **1/133** locally certified parity rows (**0.8% raw / 0.9% weighted**);
- 21 of the 22 legacy-certified rows still need mirror workflows and evidence here;
...
The next release gate remains parity mirror; F-015 ERASE is the next practical
