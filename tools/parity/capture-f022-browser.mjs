...
await run(process.execPath, [resolve(root, "node_modules/playwright/cli.js"), "test", "e2e/f022-trim.spec.ts"], {
  PARITY_CAPTURE_DIR: captureDir,
});
await run(process.execPath, [resolve(root, "tools/parity/build-f022-browser-readback.mjs")]);
